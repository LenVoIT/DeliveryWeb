                ...
                <div class="container py-4">
                    <div class="row">
                        <div class="col-lg-7 mx-auto d-flex justify-content-center flex-column">
                            ...
                            <form:form method="post" action="${action}" modelAttribute="shipperaccount">
                                ...
                                <div class="mb-4">
                                    <div class="d-flex flex-column input-group input-group-dynamic mb-4">
                                        <label class="m-0"><b>Avatar</b></label>
                                        <form:input type="file" path="userAvatar" class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
